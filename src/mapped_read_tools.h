...
void dump_nucleotide_pileup_per_SAM_file_phred_partitioning(char* sam_fp, vector<char*>* chr_ids, vector<int>* chr_lengths, char* op_dir, int min_mapp_qual, vector<int>* phred_qual_partitions, int& n_processed_reads);
